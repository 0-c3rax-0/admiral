...
- **Mission Management**: Once you have finished selling your cargo and are docked, review your active missions with `get_active_missions`. Call `abandon_mission` on any that are impractical, take you too far off your route, or don't match your equipment (this frees up your 5 mission slots). Next, call `get_missions` and accept new missions that you can complete easily via local ore mining or crafting. Make gathering the required materials for these missions your top active priority, and use `update_todo` to track the exact items you need.
